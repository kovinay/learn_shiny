...
dashboardPage(
  ...
  dashboardHeader(title="Exploring the 1973 US Arrests data with R & Shiny Dashboard", titleWidth = 650, 
                  ...
                  tags$li(class="dropdown",tags$a(href="",icon("instagram"),"My status",target="_blank" ))
  ),
      ...
      tabItem(tabName = "data", 
              tabBox(id="t1", width = 12, 
                     tabPanel("About", icon=icon("address-card"),
                              fluidRow(
                                column(width = 8, tags$img(src="https://cdn.pixabay.com/photo/2015/01/13/17/16/zombie-598390_1280.jpg", width =600 , height = 300),
                                       tags$br() , 
                                ...
                                column(width = 4, tags$br() ,
                                       tags$p("This data set comes along with base R and contains statistics,
                                              in arrests per 100,000 residents for assault, murder,
                                              and rape in each of the 50 US states in 1973. Also,
